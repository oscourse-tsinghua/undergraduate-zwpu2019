...
module pico_qsys_mm_interconnect_0 (
	...
	wire    [6:0] cmd_mux_src_channel;                                                // cmd_mux:src_channel -> rom_s1_agent:cp_channel
	...
	wire    [6:0] cmd_mux_001_src_channel;                                            // cmd_mux_001:src_channel -> ram_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_002_src_data;                                               // cmd_mux_002:src_data -> uart_0_s1_agent:cp_data
	wire          cmd_mux_002_src_ready;                                              // uart_0_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [6:0] cmd_mux_002_src_channel;                                            // cmd_mux_002:src_channel -> uart_0_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_003_src_data;                                               // cmd_mux_003:src_data -> led_s1_agent:cp_data
	...
	wire  [105:0] cmd_mux_004_src_data;                                               // cmd_mux_004:src_data -> sw_s1_agent:cp_data
	...
	wire          cmd_mux_005_src_valid;                                              // cmd_mux_005:src_valid -> seg1_s1_agent:cp_valid
	wire  [105:0] cmd_mux_005_src_data;                                               // cmd_mux_005:src_data -> seg1_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                              // seg1_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                            // cmd_mux_005:src_channel -> seg1_s1_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                      // cmd_mux_005:src_startofpacket -> seg1_s1_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                        // cmd_mux_005:src_endofpacket -> seg1_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_006_src_valid;                                              // cmd_mux_006:src_valid -> seg2_s1_agent:cp_valid
	wire  [105:0] cmd_mux_006_src_data;                                               // cmd_mux_006:src_data -> seg2_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                              // seg2_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                            // cmd_mux_006:src_channel -> seg2_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                      // cmd_mux_006:src_startofpacket -> seg2_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                        // cmd_mux_006:src_endofpacket -> seg2_s1_agent:cp_endofpacket
	...
	wire  [105:0] uart_0_s1_agent_rp_data;                                            // uart_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire          seg1_s1_agent_rp_valid;                                             // seg1_s1_agent:rp_valid -> router_007:sink_valid
	wire  [105:0] seg1_s1_agent_rp_data;                                              // seg1_s1_agent:rp_data -> router_007:sink_data
	wire          seg1_s1_agent_rp_ready;                                             // router_007:sink_ready -> seg1_s1_agent:rp_ready
	wire          seg1_s1_agent_rp_startofpacket;                                     // seg1_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          seg1_s1_agent_rp_endofpacket;                                       // seg1_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire          seg2_s1_agent_rp_valid;                                             // seg2_s1_agent:rp_valid -> router_008:sink_valid
	wire  [105:0] seg2_s1_agent_rp_data;                                              // seg2_s1_agent:rp_data -> router_008:sink_data
	wire          seg2_s1_agent_rp_ready;                                             // router_008:sink_ready -> seg2_s1_agent:rp_ready
	wire          seg2_s1_agent_rp_startofpacket;                                     // seg2_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          seg2_s1_agent_rp_endofpacket;                                       // seg2_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          seg1_s1_agent_rdata_fifo_out_valid;                                 // seg1_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] seg1_s1_agent_rdata_fifo_out_data;                                  // seg1_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_005:in_0_data
	wire          seg1_s1_agent_rdata_fifo_out_ready;                                 // avalon_st_adapter_005:in_0_ready -> seg1_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_005_out_0_valid;                                  // avalon_st_adapter_005:out_0_valid -> seg1_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                   // avalon_st_adapter_005:out_0_data -> seg1_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                  // seg1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                  // avalon_st_adapter_005:out_0_error -> seg1_s1_agent:rdata_fifo_sink_error
	wire          seg2_s1_agent_rdata_fifo_out_valid;                                 // seg2_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] seg2_s1_agent_rdata_fifo_out_data;                                  // seg2_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_006:in_0_data
	wire          seg2_s1_agent_rdata_fifo_out_ready;                                 // avalon_st_adapter_006:in_0_ready -> seg2_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_006_out_0_valid;                                  // avalon_st_adapter_006:out_0_valid -> seg2_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                   // avalon_st_adapter_006:out_0_data -> seg2_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                  // seg2_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                  // avalon_st_adapter_006:out_0_error -> seg2_s1_agent:rdata_fifo_sink_error
